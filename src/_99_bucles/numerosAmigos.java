...
public class numerosAmigos {
    ...
    public static void main(String[] args) {
        ...
        do {
            num1 = _0103_Consola_PedidorDeDatos.pedirInt("Primer Número:");
        } while (_0104_Consola_ValidarDatos.validarEntero(num1) == -1);

        do {
            num2 = _0103_Consola_PedidorDeDatos.pedirInt("Segundo Número:");
        } while (_0104_Consola_ValidarDatos.validarEntero(num2) == -1);
