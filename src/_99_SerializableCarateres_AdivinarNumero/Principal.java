package _99_SerializableCarateres_AdivinarNumero;
...
public class Principal {
    ...
    private static void modoIteractivo() {
        int numMaxOculto;
        do {
            numMaxOculto = _0103_Consola_PedidorDeDatos.pedirInt("Número máximo a adivinar:");
        } while (_0104_Consola_ValidarDatos.validarNumMaxOculto(numMaxOculto) == -1);
        ...
        do {
            do {
                numJugado = _0103_Consola_PedidorDeDatos.pedirInt("Número a jugar:");
            } while (_0104_Consola_ValidarDatos.validarEntero(numJugado) == -1);
    ...
    private static void simularJuego(File f) {
        ...
        int numJugadores;
        do {
            numJugadores = _0103_Consola_PedidorDeDatos.pedirInt("Número de Jugadores:");
        } while (_0104_Consola_ValidarDatos.validarEntero(numJugadores) == -1);
